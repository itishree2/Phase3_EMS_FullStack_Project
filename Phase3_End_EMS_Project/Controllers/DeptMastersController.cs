...
using Phase3_End_EMS_Project.Models;

namespace Phase3_End_EMS_Project.Controllers
{
    ...
    public class DeptMastersController : ControllerBase
    {
        ...
        public DeptMastersController(EmpDeptDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<DeptMaster>> PostDeptMaster(DeptMaster deptMaster)
        {
          if (_context.DeptMasters == null)
          {
              return Problem("Entity set 'EmpDeptDbContext.DeptMasters'  is null.");
          }
